...
export const QuestionSchema = z.object({
    ...
    toppers_approach: z.string().optional().nullable(),
...
export const PaperSchema = z.object({
    ...
    allow_sectional_attempts: z.boolean().optional().nullable(),
    sectional_allowed_sections: z.array(SectionNameSchema).optional().nullable(),
    created_at: z.string(),
    updated_at: z.string(),
});
...
export const AttemptSchema = z.object({
    ...
    attempt_mode: z.enum(['full', 'sectional']).optional().nullable(),
    sectional_section: SectionNameSchema.optional().nullable(),
